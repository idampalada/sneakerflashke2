...
public function getShippingConfig()
{
    return response()->json([
        ...
        'store_location' => env('STORE_LOCATION_NAME', 'Jl. Komp Graha Indah Green Ville Blok X No 34 RT 16 RW 9, Jakarta Barat'),
...
private function createMidtransPayment($order, $cartItems, $request)
{
    ...
    {
        $originCityName = env('STORE_ORIGIN_CITY_NAME', 'Jakarta Barat');
...
private function createKomerceOrderSync($order, $request = null, $orderItems = null)
{
    try {
        ...
        $komerceData = [
            ...
            'shipper_phone' => env('STORE_SHIPPER_PHONE', '081313911391'),
            'shipper_email' => env('STORE_SHIPPER_EMAIL', 'store@sneakersflash.com'),
            'shipper_destination_id' => 17485,
            'shipper_address' => 'Jl. Komp Graha Indah Green Ville Blok X No 34 RT 16 RW 9',
            ...
            'receiver_destination_id' => (int) ($order->shipping_destination_id ?? env('KOMERCE_DEFAULT_DESTINATION_ID', 17485)),
